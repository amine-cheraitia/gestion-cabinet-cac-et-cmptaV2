...
*/
    ...
    newMomentProto.toISOString = function () {
        ...
        if (this._fullCalendar) {
            ...
            return oldMomentProto.toISOString.apply(
                englishMoment(this),
                arguments
            );
        }
...
*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        listenToExternalDrag: function (el, ev, ui) {
            ...
            var dragListener = (_this.externalDragListener =
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    function Toolbar(calendar, toolbarOptions) {
        ...
        function activateButton(buttonName) {
            if (el) {
                el.find(".fc-" + buttonName + "-button").addClass(
                    tm + "-state-active"
                );
            }
        }
...
*/
    ...
    Calendar.mixin({
        ...
        renderView: function (viewType, forcedScroll) {
            ...
            var needsClearView =
                this.view && viewType && this.view.type !== viewType;
    ...
    var YearView = (FC.YearView = View.extend({
        ...
        handleSegMouseout: function (seg, ev) {
            if (this.activeGridId != -1) {
                return this.dayGrids[this.activeGridId].handleSegMouseout(
                    seg,
                    ev
                );
            }
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        updateCells: function () {
            ...
            this.subTables.each(function (i, _sub) {
                ...
                var endDaysHidden =
                    _this.daysInMonth(_this.curYear.year(), mi + 1) -
                    lastDateShown;
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        computeSelection: function (span0, span1) {
            ...
            if (startId == activeId) {
                ...
                if (startId > activeId) {
                    first = this.dayGrids[activeId].computeSelection(
                        span0,
                        span1
                    );
                    ...
                    if (activeId != -1) {
                        if (startId < activeId) {
                            for (i = startId; i < activeId; i++) {
                                ...
                                selectionSpan = dayGrid.computeSelection(
                                    span0,
                                    span1
                                );
