...
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active"><a class="text-dark" href="{{route('/')}}">Tableau de bord</a> / <a
            ...
            Entreprises</a> / Modification de la fiche d'entreprise N°{{$entreprise->id}}</li>
</ol>
<div class="card shadow">
    <div class="card-header">
        <i class="far fa-address-card"></i> <strong>Modification de la fiche d'entreprise N°{{$entreprise->id}}</strong>
    </div>
    <div class="card-body">
